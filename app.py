...
# ===================== ANALISIS EMOSI VIA GROQ LLM =====================
def analyze_emotion_via_groq(api_key, user_text: str) -> dict:
    """Menggunakan Groq AI (llama-3.1-8b-instant) untuk deteksi emosi & kalimat penguat sekaligus."""
    if not api_key:
        return {
            "emosi": "neutral",
            "perlu_rujukan": False,
    ...
    system_prompt = (
        ...
        '  "ai_label": "1 kalimat penguat yang sangat hangat, lembut, dan natural (maksimal 12-15 kata)"\n'
        "}\n\n"
        "ATURAN:\n"
        "- Set 'perlu_rujukan' = true HANYA jika emosi tergolong 'sadness', 'fear', atau kondisi tertekan/distress berat.\n"
        "- Bahasa 'ai_label' harus santai, empati, tanpa tanda kutip, seperti teman dekat."
    )
